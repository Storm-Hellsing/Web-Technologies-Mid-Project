<html>
  ...
  <body>
    ...
    <h1 align="center">Privacy and Confidentiality </h1>
    <hr/>

    <h4> Welcome to the EUPHORIA website operated from Bangladesh. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy. </h4>
    <ol>
      ...
      <li>Data that we collect: </li>
        ...
        <ol type="A">
          ...
          <li>MARKETPLACE shall collect the following information where you are a buyer:</li>
        ...
        <li> MARKETPLACE shall collect the following information where you are a seller: </li>
        <ol type="I">
    ...
    <li> Other uses of your Personal Information </li>
      <ol type="A">
    ...
    <li> Competitions: For any competition we use the data to notify winners and advertise our offers. You can find more details where applicable in our participation terms for the respective competition.
    </li>

    <li> Third Parties and Links: </li>
      <ol type="A">
        ...
        <li> We may share (or permit the sharing of) your personal data with and/or transfer your personal data to third parties and/or our affiliates for the above-mentioned purposes. These third parties and affiliates, which may be located inside or outside your jurisdiction. </li>
    ...
    <li> Your rights: If you are concerned about your data, you have the right to request access to the personal data which we may hold or process about you. You have the right to require us to correct any inaccuracies in your data free of charge. At any stage you also have the right to ask us to stop using your personal data for direct marketing purposes.
      ...
      Furthermore, you also have the right to ask us to delete your data. If you would like to have your data deleted, fill out the Account Deactivation/Deletion Request Form (“Deletion Request”) or email your request to customer.bd@care.euphoria.com. Once your request is received, we follow an internal deletion process to make sure that your data is safely removed in the next fifteen (15) working days. You'll be contacted for verification and your account will be deleted after necessary protocols are conformed to. Read more about the deletion process here. </li>
    ...
    <li> Minors </li>
      <ol type="A">
        ...
        <li> If you allow a minor to access the Site and buy products from the Site by using your account, you hereby consent to the processing of the minors personal data and accept and agree to be bound by this Privacy Policy and take responsibility for his or her actions. </li>
        <li> We will not be responsible for any unauthorized use of your account on the Site by yourself, users who act on your behalf or any unauthorized users. It is your responsibility to make your own informed decisions about the use of the Site and take necessary steps to prevent any misuse of the Site.
        </li>
